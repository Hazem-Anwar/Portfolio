  ...
  return (
    ...
    >
      <svg
        ...
        height="20"
        viewBox="0 0 24 24"
        className="drop-shadow-md z-10 mt-1 mr-[-6px]"
      >
        <path
          d="M5 3L19 10L12.5 13.5L9 20L5 3Z"
          fill="#a855f7"
          stroke="white"
          strokeWidth="2"
      ...
      <div
        className="flex flex-col text-left mt-4"
...
export default function AboutArchivePage() {
  ...
  const photos = [
    ...
    {
      src: "/images/about/hazem_ahmed.jpg",
      alt: "Family First",
      x: "-20%",
      y: "580px",
    },
  ...
  return (
    <div
      ref={containerRef}
      className="bg-bg min-h-screen relative overflow-x-hidden"
    >
      <NavbarLight />
      <div
        ref={cursorRef}
        className="fixed pointer-events-none z-[200] opacity-0 flex flex-row items-start font-sans"
      >
        <svg
          width="24"
          height="24"
      ...
      {activePhotoIdx === 0 && (
        <PhotoTag text={firstPhotoAlt} active={true} cursorPos={cursorPos} />
      )}

      <main className="max-w-[1440px] mx-auto px-6 md:px-12 pt-24 lg:pt-[140px] relative z-10">
        <section
          id="hero-section"
          className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-20 items-start pb-6 lg:pb-40 relative"
        >
          <div
            ref={leftColRef}
            className="reveal-pinned flex flex-col justify-start max-lg:pb-4 lg:pb-20"
          >
            ...
            <div className="relative inline-block mb-12">
              <h1
                ref={titleRef}
                className="font-display text-[84px] md:text-[160px] leading-[0.85] tracking-[-0.02em] relative"
              >
                ABOUT
              </h1>
            ...
            <div className="flex flex-col gap-10">
              <p className="text-[24px] md:text-[34px] font-light leading-[1.3] text-text/90 max-w-[720px]">
                ...
                <strong className="font-medium text-text border-b-2 border-[#e4fe9a]/60 pb-1">
                  craft isn&apos;t a shortcut
                </strong>{" "}
                — it&apos;s the path. I design for those who crave clarity
                without sacrificing depth. I build things that move, feel
                intentional, and{" "}
                <em className="italic text-text/70">actually ship</em>.
              </p>
              <div className="space-y-12 mt-4">
                <div className="flex flex-col">
                  <span className="font-mono text-[12px] text-[#e4fe9a] tracking-widest uppercase mb-4 opacity-80">
                    01 / The Drive
                  </span>
                  <p className="text-[17px] md:text-[20px] text-text/50 max-w-[620px] leading-[1.7] font-light">
                    I design for those who refuse to blend in. I craft digital
                    experiences that are bold, memorable, and engineered to
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-[17px] md:text-[20px] text-text/50 max-w-[620px] leading-[1.7] font-light">
                    When I&apos;m not pushing pixels, you&apos;ll find me in{" "}
                    <strong className="text-text/70 font-medium italic">
                      Minecraft
                    </strong>{" "}
                    — solving problems on the fly. It&apos;s the nerd side of
                    me, and I&apos;m not sorry about it.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-[#e4fe9a] w-[100vw] relative left-1/2 -translate-x-1/2 px-6 md:px-12 py-24 md:py-40 grid grid-cols-1 md:grid-cols-3 gap-20 md:gap-0 lg:mt-24 mt-16 reveal containe">
          <div className="text-center md:px-12 md:border-r border-black/10">
            <div className="font-display text-[84px] md:text-[130px] leading-none text-bg tracking-[-0.04em]">
              5+
            </div>
            <div className="font-mono text-[14px] md:text-[16px] tracking-[0.3em] uppercase text-bg/40 mt-4 leading-none">
              Years Experience
            </div>
          </div>
          <div className="text-center md:px-12 md:border-r border-black/10">
        ...
        <section className="py-32 border-t border-border mt-32">
          <div className="flex items-baseline gap-5 mb-16 reveal">
            <span className="font-mono text-[11px] tracking-[0.2em] text-[#e4fe9a]">
              01
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-16 reveal">
            ...
            <div className="text-[18px] md:text-[20px] font-light leading-[1.8] text-text/80 space-y-8">
              <p>
                ...
                based in EMEA. What makes me different:{" "}
                <strong className="text-text font-medium border-b border-[#e4fe9a]/30 pb-px">
                  I design and build
                </strong>
                . No handoff friction. No &quot;that&apos;s an engineering
                problem.&quot;
              </p>
              <div className="text-[24px] md:text-[28px] font-light italic text-text border-l-[3px] border-[#e4fe9a] pl-8 py-2 leading-relaxed opacity-90">
                Father. United supporter. Losing at FIFA to a four-year-old who
                has no business being that good.
              </div>
              <p>
                I studied Multimedia & Web Development at the Islamic University
                of Gaza — a place that taught me resourcefulness as much as
                technology. Today I work across the full product lifecycle:
                research, design, implementation, and quality assurance.
              </p>
            </div>
          </div>
        </section>
            ...
            {[
              {
                ...
                desc: "Full-stack design and engineering across booking, loyalty, and real estate platforms. Design systems, React implementation, and SQA.",
                company: "Freelance",
              },
              {
                years: "2022 — 2024",
                title: "Senior UX Designer",
                desc: "Led end-to-end product design for a loyalty and gamification platform serving 200k+ users. Built the company's first design system.",
                company: "Loyalty Co.",
              },
              {
                years: "2020 — 2022",
                title: "UI/UX Designer",
                desc: "Designed mobile-first experiences for iOS and Android. Introduced component-based design thinking to the team.",
                company: "Tech Studio",
              },
              {
                years: "2019 — 2020",
                title: "Frontend Developer",
                desc: "Built responsive interfaces with React and Vue. Bridged the gap between design mockups and production code.",
                company: "Agency",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="timeline-row grid grid-cols-1 md:grid-cols-[120px_1fr_auto] gap-8 items-baseline py-7 border-b border-border hover:bg-white/[0.02] transition-colors group"
              >
                <span className="font-mono text-[11px] tracking-[0.12em] text-muted">
                  {item.years}
                </span>
                <div>
                  <div className="text-[16px] font-medium mb-1 text-text">
                    {item.title}
                  </div>
                  <div className="text-[14px] text-muted max-w-[480px] leading-relaxed">
                    {item.desc}
                  </div>
                </div>
                <span className="font-mono text-[11px] tracking-[0.12em] uppercase text-[#e4fe9a]">
                  {item.company}
                </span>
              </div>
            ))}
            ...
            {[
              {
                num: "01",
                name: "People First",
                desc: "Every pixel, every component, every interaction exists to serve a human being. I start with why before I start with how.",
              },
              {
                num: "02",
                name: "Commit to Craft",
                desc: "Lazy good enough isn't good enough. Every project deserves intention — in the typography, the animation, the edge cases.",
              },
              {
                num: "03",
                name: "Adapt & Iterate",
                desc: "Plans change. Users surprise you. Great design adapts without losing its core intention. Ship, learn, improve.",
              },
              {
                num: "04",
                name: "Connect the Dots",
                desc: "Design and engineering aren't separate disciplines — they're the same conversation. I speak both languages fluently.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="foundation-item bg-bg p-8 md:p-9 hover:bg-white/[0.02] transition-colors"
              >
                <div className="font-mono text-[11px] text-[#e4fe9a] tracking-[0.2em] mb-3">
                  {item.num}
                </div>
                <div className="text-[18px] font-medium mb-2.5">
                  {item.name}
                </div>
            ...
            {[
              {
                ...
                desc: "Building scalable design languages and establishing governance frameworks that keep teams moving fast and aligned.",
              },
              {
                icon: "◲",
                name: "Platform 0-to-1 Products",
                desc: "Taking products from zero to launch — defining vision, architecture, and experience across web and mobile surfaces.",
              },
              {
                icon: "⊞",
                name: "Cross-Functional Delivery",
                desc: "Shipping design as code. Reducing handoff friction. Delivering production-ready components that match the design exactly.",
              },
              {
                icon: "◇",
                name: "Strategic Product Thinking",
                desc: "Connecting business objectives to user needs. Knowing which problems are worth solving and in what order.",
              },
              {
                icon: "∿",
                name: "Quality & SQA",
                desc: "Manual testing, UI/UX QA, and performance auditing. Shipping with confidence, not crossed fingers.",
              },
              {
                icon: "◉",
                name: "Animation & Interaction",
                desc: "GSAP, Framer Motion, Three.js. Motion that feels intentional — not decoration, but communication.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="comp-row grid grid-cols-[32px_1fr] md:grid-cols-[40px_200px_1fr] gap-8 items-start py-6 border-b border-border hover:bg-white/[0.018] transition-colors"
              >
                <div className="w-8 h-8 border border-border flex items-center justify-center text-[14px] shrink-0">
                  {item.icon}
                </div>
                <div className="text-[15px] font-medium pt-1.5 md:pt-1">
                  {item.name}
                </div>
                <div className="hidden md:block text-[14px] text-muted leading-[1.65]">
                  {item.desc}
                </div>
              </div>
            ))}
        ...
        <section className="py-24 border-t border-border">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-12 reveal">
            ...
            <div className="text-[17px] font-light leading-[1.85] text-text/80">
              <p>
                Father of Ahmed — the reason there&apos;s a Minecraft room in
                this portfolio. Manchester United supporter since before I
                understood what relegation meant. Video game enthusiast who
                takes co-op sessions more seriously than he should. Currently
                losing at FIFA to a four-year-old. It&apos;s humbling.
              </p>
            </div>
          </div>
        </section>
