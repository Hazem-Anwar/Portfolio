...
export default function CaseStudy({ params }: { params: { slug: string } }) {
  ...
  useEffect(() => {
    ...
    const updateScrollers = () => {
      scrollers = Array.from(document.querySelectorAll('[data-auto-scroll="true"]'));
    };
      ...
      <div className="max-w-[720px] mx-auto px-6 space-y-12">
        ...
        <section className="pt-40 space-y-8">
           <div className="space-y-4">
              <h1 ref={titleRef} className="text-[32px] md:text-[44px] font-extrabold leading-[1.1] tracking-tight uppercase text-[#111]">{c.title}</h1>
              <p className="text-[16px] md:text-[18px] text-[#555] leading-[1.6] max-w-[640px]">{c.description}</p>
           </div>
           ...
           <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 py-10 border-y border-black/5">
              ...
              <div className="flex flex-col gap-3">
                 <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#aaa]">Ecosystem</span>
                 <div className="flex items-center gap-6">
                    ...
                    {/* Android */}
                    <div className="flex items-center gap-2 group cursor-default">
                       <svg width="18" height="18" viewBox="0 0 24 24" fill="#3DDC84"><path d="M17.523 15.3414c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9997.9993-.9997c.5511 0 .9993.4486.9993.9997.0001.5511-.4482.9997-.9993.9997zM6.477 15.3414c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9997.9993-.9997c.5511 0 .9993.4486.9993.9997.0001.5511-.4482.9997-.9993.9997zM17.885 10.587l1.733-3.0022a.498.498 0 00-.099-.6897.498.498 0 00-.6897.099l-1.751 3.0336c-1.482-.6769-3.136-1.0543-4.897-1.0543s-3.415.3774-4.897 1.0543L5.5343 6.9941a.498.498 0 00-.6897-.099.498.498 0 00-.099.6897l1.733 3.0022c-2.923 1.4801-4.975 4.417-5.321 7.89H19.337v-.001c-.347-3.473-2.399-6.411-5.321-7.89z" /></svg>
                       <span className="text-[12px] font-bold text-[#111]">Android</span>
                    </div>
                    {/* Web Platform */}
                    <div className="flex items-center gap-2 group cursor-default">
                       <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4285F4" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 0 1-9 9m9-9a9 9 0 0 0-9-9m9 9H3m9 9a9 9 0 0 1-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9h18" /></svg>
                       <span className="text-[12px] font-bold text-[#111]">Web Site</span>
                    </div>
                 </div>
              </div>
              ...
              {/* DESIGN STACK */}
              <div className="flex flex-col gap-3">
                 <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#aaa]">Design Stack</span>
                 <div className="flex items-center gap-6">
                    {/* FIGMA (PERFECT FIDELITY) */}
                    <div className="flex items-center gap-2">
                       <svg width="15" height="22" viewBox="0 0 38 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path d="M19 19H28.5C33.7467 19 38 23.2533 38 28.5C38 33.7467 33.7467 38 28.5 38H19V19Z" fill="#1ABCFE"/>
                          <path d="M19 38H9.5C4.2533 38 0 42.2533 0 47.5C0 52.7467 4.2533 57 9.5 57C14.7467 57 19 52.7467 19 47.5V38Z" fill="#0ACF83"/>
                       </svg>
                       <span className="text-[12px] font-bold text-[#111]">Figma</span>
                    </div>
                    {/* PHOTOSHOP (REAL TILE) */}
                    <div className="flex items-center gap-2">
                       <div className="w-[18px] h-[18px] bg-[#001E36] rounded-[2px] flex items-center justify-center border border-white/5 shadow-sm">
                          <span className="text-[#31A8FF] font-black text-[7px] tracking-tighter">Ps</span>
                       </div>
                       <span className="text-[12px] font-bold text-[#111]">Photoshop</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                       <div className="w-[18px] h-[18px] bg-[#330000] rounded-[2px] flex items-center justify-center border border-white/10 shadow-sm">
                          <span className="text-[#FF9A00] font-black text-[7px] tracking-tighter">Ai</span>
                       </div>
                       <span className="text-[12px] font-bold text-[#111]">Illustrator</span>
                    </div>
                 </div>
              </div>
              ...
              <div className="flex items-center">
                 {c.link && (
                    ...
                    >
                      <div className="flex items-center gap-2">
                         <span className="text-[13px] font-black uppercase tracking-wider">Live View</span>
        ...
        <section className="space-y-12">
           {(c as any).detailedSections ? (
             (c as any).detailedSections.map((section: any, index: number) => (
               <div key={index} className="space-y-8 pb-12 border-b border-black/5 last:border-0 last:pb-0">
                  <div 
                    onClick={() => {
                  ...
                  <div className="space-y-3">
                    <div className="space-y-1">
                      <h2 className="text-[16px] font-bold uppercase tracking-wider text-[#111]">{section.title}</h2>
                      {section.subTitle && <p className="text-[14px] font-medium text-[#888] leading-tight">{section.subTitle}</p>}
                    </div>
                     ...
                     <div className="mt-12 bg-[#f1f1f1] p-8 md:p-4 lg:p-6 rounded-[16px] border border-black/5">
                        <div className="space-y-8">
                           <div className="space-y-3 max-w-[500px]">
                              <span className="text-[8px] font-bold uppercase tracking-[0.4em] text-[#888]">Experience Loop</span>
                              <h3 className="text-[16px] md:text-[20px] font-black text-[#111] leading-tight">Full HomePage Scroll.</h3>
                           </div>
                           <div className="relative group w-full h-[45vh] md:h-[65vh] rounded-xl bg-white border border-black/5 overflow-hidden shadow-sm">
                              ...
                              <div className="absolute bottom-6 left-6 pointer-events-none opacity-100 group-hover:opacity-0 transition-opacity">
                                 <div className="flex items-center gap-2 bg-white/40 backdrop-blur-md px-3 py-1.5 rounded-full border border-black/5 shadow-sm scale-90">
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-widest text-[#111]">Interactive Preview</span>
                                 </div>
                              </div>
                           </div>
                        </div>
             ...
             <>
               {/* IMAGE 01: HERO COVER */}
               <div onClick={() => setSelectedIndex(0)} className="w-full rounded-2xl overflow-hidden bg-[#f7f7f7] cursor-zoom-in group border border-black/5">
                  <Image src={c.image || ""} alt={c.title} width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }} className="group-hover:scale-[1.02] transition-transform duration-700" priority />
               </div>
               ...
               {c.images?.[1] && (
                  <div onClick={() => setSelectedIndex(1)} className="w-full rounded-2xl overflow-hidden bg-[#fafafa] cursor-zoom-in border border-black/5">
                     <Image src={c.images?.[1]} alt="Architecture" width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }} />
                  </div>
               )}
               ...
               <div className="grid grid-cols-2 gap-4">
                  <div onClick={() => setSelectedIndex(2)} className="w-full rounded-xl overflow-hidden bg-[#f7f7f7] cursor-zoom-in border border-black/5">
                     <Image src={c.images?.[2] || c.image} alt="Detail A" width={0} height={0} sizes="50vw" style={{ width: '100%', height: 'auto' }} />
                  </div>
                  <div onClick={() => setSelectedIndex(3)} className="w-full rounded-xl overflow-hidden bg-[#f7f7f7] cursor-zoom-in border border-black/5">
                     <Image src={c.images?.[3] || c.image} alt="Detail B" width={0} height={0} sizes="50vw" style={{ width: '100%', height: 'auto' }} />
                  </div>
               </div>
           ...
           {((c as any).designSystem || c.designSystem) && (
              <div className="bg-[#f9f9f9] p-8 md:p-14 rounded-2xl space-y-12 border border-black/5 mt-12">
                  <div className="space-y-4">
                     ...
                     <p className="text-[16px] text-[#555] leading-relaxed">{(c as any).designSystem}</p>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                     ...
                     <div className="flex flex-col justify-end">
                        ...
                        <span className="text-[11px] text-[#aaa] font-mono mt-4 uppercase tracking-widest">Inter System</span>
                     </div>
                  </div>
           ...
           {!(c as any).detailedSections && (
             <div className="space-y-20 mt-20">
                ...
                <div onClick={() => setSelectedIndex(2)} className="w-full rounded-3xl overflow-hidden bg-[#fafafa] cursor-zoom-in border border-black/5">
                    <Image src={c.images?.[2] || c.image} alt="Prototyping" width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }} />
                </div>
                ...
                <div onClick={() => setSelectedIndex(3)} className="w-full rounded-2xl overflow-hidden bg-[#fafafa] cursor-zoom-in border border-black/5">
                    <Image src={c.images?.[3] || c.image} alt="Testing" width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }} />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-20">
               {c.stats.map((stat, i) => (
                  <div key={i} className="bg-[#f9f9f9] p-8 md:p-12 rounded-2xl space-y-4 border border-black/5 shadow-sm group hover:border-[#FF5C00]/20 transition-all duration-500">
                     <div className="text-[32px] md:text-[48px] font-black tracking-tight text-[#111] leading-none">{stat.value}</div>
                     <div className="text-[14px] font-bold uppercase text-[#111] tracking-widest leading-relaxed">{stat.label}</div>
                  </div>
               ))}
            </div>

            {/* KEY TAKEAWAYS (STANDARDIZED NARRATIVE) */}
            {(c as any).keyTakeaways && (
               <div className="mt-20 space-y-2">
                  <h2 className="text-[16px] font-bold uppercase tracking-wider text-[#111]">Key Takeaways</h2>
                  <div className="text-[16px] text-[#555] leading-[1.8]">
                     <p>{(c as any).keyTakeaways.map((t: any) => t.content).join(' ')}</p>
                  </div>
               </div>
            )}
            ...
            <div className="space-y-2 mt-20">
               <h2 className="text-[16px] font-bold uppercase tracking-wider text-[#111]">Final Word</h2>
               <div className="text-[16px] text-[#555] leading-[1.8]">
                  <p>{c.outcome}</p>
               </div>
            </div>
