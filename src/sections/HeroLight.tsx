...
const NextjsIcon = () => (
  <svg width="18" height="18" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
    <path d="M64 0C28.7 0 0 28.7 0 64s28.7 64 64 64c11.2 0 21.7-2.9 30.8-7.9L48.4 55.3v36.6h-6.8V41.8h6.8l50.5 75.8C116.4 106.2 128 86.5 128 64c0-35.3-28.7-64-64-64zm22.1 84.6l-7.5-11.3V41.8h7.5v42.8z" fill="#111"/>
  </svg>
);
...
const FigmaIcon = () => (
  <svg width="14" height="18" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
...
const GSAPIcon = () => (
  <span className="text-[#88ce02] font-black text-[12px] tracking-tight leading-none">GSAP</span>
);

const AgileIcon = () => (
  <svg width="18" height="18" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="agile-grad-a" gradientUnits="userSpaceOnUse" x1="22.034" y1="9.773" x2="17.118" y2="14.842" gradientTransform="scale(4)">
        <stop offset=".176" stopColor="#0052cc"/><stop offset="1" stopColor="#2684ff"/>
      </linearGradient>
      <linearGradient id="agile-grad-b" gradientUnits="userSpaceOnUse" x1="16.641" y1="15.564" x2="10.957" y2="21.094" gradientTransform="scale(4)">
        <stop offset=".176" stopColor="#0052cc"/><stop offset="1" stopColor="#2684ff"/>
      </linearGradient>
    </defs>
    ...
    <path d="M85.121 39.04H38.902c0 11.519 9.325 20.847 20.844 20.847h8.504v8.226c0 11.52 9.328 20.848 20.848 20.848V43.016a3.983 3.983 0 00-3.977-3.977zm0 0" fill="url(#agile-grad-a)"/>
    <path d="M62.219 62.078H16c0 11.524 9.324 20.848 20.848 20.848h8.5v8.23c0 11.52 9.328 20.844 20.847 20.844V66.059a3.984 3.984 0 00-3.976-3.98zm0 0" fill="url(#agile-grad-b)"/>
  </svg>
);

const FramerIcon = () => (
  <svg width="18" height="18" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
    <path d="M22.5 0h83v41.5l-41.5 41.5H22.5l41.5-41.5L22.5 0zm0 83h41.5L107 124.5H22.5V83z" fill="black"/>
  </svg>
);
...
const ALL_SKILLS = [
  ...
  { name: "Laravel", icon: <svg width="18" height="18" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg"><path d="M121.3 28.1L70.4 2v20.4L42.5 35 15.6 48.6 0 60.3l13.6 7.4 28.1 15.4 25.1 13.8 52.7-26V28.1zM28.1 59.4L13.8 50.8l14.3-7.4 14.4 7.4 14.4 8.6-28.8-7.4zm28.1 31.5l-14.4-7.4 14.4-7.4 14.4 7.4-14.4 7.4zm61.1-34l-14.3 7.4-14.4-7.4V40.2l14.4-7.4 14.3 7.4v16.7z" fill="#FF2D20"/></svg> },
      ...
      <div className="container-custom md:pt-[80px] pt-10   flex-1 flex flex-col relative z-10 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-14 lg:gap-16 items-center w-full">
          ...
          <div className="flex flex-col lg:pt-10 z-10 min-w-0 order-2 md:order-1">
            ...
            <h1 
              ref={headingRef}
              className="font-bricolage font-extrabold mt-2 text-[clamp(2.5rem,6vw,44px)] md:text-[clamp(1.8rem,4vw,44px)] lg:text-[48px] leading-[1.1] tracking-[-0.03em] text-[#111] opacity-0"
            >
            ...
            <div ref={btnsRef} className="md:mt-6 mt-4 flex flex-row flex-wrap items-center gap-3 md:gap-4 opacity-0">
              <Link
                href="/work"
            ...
            <div ref={skillsRef} className="mt-4 md:mt-6 flex flex-row items-center h-[24px] opacity-0">
              <div className="flex flex-row flex-wrap items-center gap-x-4 gap-y-3">
                <AnimatePresence mode="popLayout">
                  {visibleSkills.map((skill, i) => (
                    <div key={skill.name} className="flex items-center gap-x-4 overflow-hidden py-1">
                      <motion.div 
                      ...
                      >
                        ...
                        <span className="text-[13px] md:text-[14px] text-[#444] font-semibold whitespace-nowrap tracking-tight">{skill.name}</span>
                      </motion.div>
