    ...
    <>
      ...
      >
        <div className="container-custom flex items-center justify-between relative font-epilogue">
          ...
          <Link
            href="/"
            className="text-[20px] font-bold tracking-tight hover:scale-[1.05] transition-all duration-300 z-10"
          >
            HA<span className="text-[#ff4d00]">.</span>
          </Link>

          {/* Centered Pill Navigation */}
          <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center bg-[#f2f2f2]/80 backdrop-blur-md p-1 rounded-full border border-[#eee]">
            <Link
              href="/"
          ...
          <div className="hidden md:flex items-center z-10">
            ...
            >
              ...
              <svg
                ...
                className="transition-transform duration-300 group-hover:rotate-[45deg] group-hover:translate-x-[2px]"
              >
          ...
          >
            <div className="relative w-6 h-5 flex flex-col items-end justify-center gap-[7px]">
              <span
                className={`h-[2px] bg-[#111] rounded-full transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${isOpen ? "w-6 rotate-45 translate-y-[4.5px]" : "w-6"}`}
              />
              <span
                className={`h-[2px] bg-[#111] rounded-full transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${isOpen ? "w-6 -rotate-45 -translate-y-[4.5px]" : "w-4"}`}
              />
            </div>
          </button>
        </div>
      ...
      >
        <Link
          href="/"
          onClick={(e) => {
            if (isHome) handleScrollTo(e, "body");
