export default function Tools() {
  ...
  const GitHubLogo = () => (
    <svg
      viewBox="0 0 24 24"
      className="w-full h-full fill-white transition-all duration-300 group-hover:scale-110"
      xmlns="http://www.w3.org/2000/svg"
    >
  ...
  const IllustratorLogo = () => (
    <svg width="28" height="28" viewBox="0 0 512 512" fill="none">
      ...
      <path
        d="M140 150L210 370H170L155 320H95L80 370H40L110 150H140ZM145 285L125 210L105 285H145Z"
        fill="#FF9A00"
      />
  ...
  const PhotoshopLogo = () => (
    <svg width="28" height="28" viewBox="0 0 512 512" fill="none">
      ...
      <path
        d="M120 150H180C210 150 230 170 230 195S210 240 180 240H160V370H120V150ZM160 190V210H180C190 210 195 205 195 200S190 190 180 190H160Z"
        fill="#31A8FF"
      />
      <path
        d="M270 280C270 250 290 230 320 230C350 230 370 250 370 280V370H330V280C330 275 325 270 320 270S310 275 310 280V370H270V280Z"
        fill="#31A8FF"
      />
    </svg>
  );
      ...
      >
        <div className="container-custom">
          ...
          {[
              ...
              items: [
                {
                  logo: <ReactLogo />,
                  name: "React / Next.js",
                  sub: "App Router · SSR/SSG · Scalable full-stack apps",
                },
                {
                  logo: <TSLogo />,
                  name: "TypeScript",
                  sub: "Type-safe architecture · Maintainable codebase",
                },
                {
                  logo: <TailwindLogo />,
                  name: "Tailwind CSS",
                  sub: "Utility-first styling · Rapid UI building",
                },
                {
                  logo: <GSAPLogo />,
                  name: "GSAP + Three.js",
                  sub: "Advanced animations · Interactive 3D",
                  wideLogo: true,
                },
              ],
            },
              ...
              items: [
                {
                  logo: <FigmaLogo />,
                  name: "Figma",
                  sub: "UI systems · Design tokens · Prototyping",
                },
                {
                  logo: <FigJamLogo />,
                  name: "FigJam",
                  sub: "User journeys · Wireframes · Ideation",
                },
                {
                  logo: <IllustratorLogo />,
                  name: "Illustrator",
                  sub: "Vector assets · Icons · Brand identity",
                },
                {
                  logo: <PhotoshopLogo />,
                  name: "Photoshop",
                  sub: "Visual editing · Mockups · Asset refinement",
                },
              ],
            },
            {
              ...
              items: [
                {
                  logo: <ClaudeLogo />,
                  name: "Claude AI",
                  sub: "Primary coding assistant · Deep reasoning · Architecture Decisions",
                },
                {
                  logo: <ChatGPTLogo />,
                  name: "ChatGPT",
                  sub: "Problem solving · Debugging · System thinking",
                },
                {
                  logo: <GeminiLogo />,
                  name: "Google Gemini",
                  sub: "Research · Exploration · Quick iterations",
                },
                {
                  logo: <AntigravityLogo />,
                  name: "Google Antigravity",
                  sub: "Creative coding · Experimental UI ideas",
                },
              ],
            },
            {
              ...
              items: [
                {
                  logo: <PlaywrightLogo />,
                  name: "Playwright",
                  sub: "End-to-end testing · Reliable automation · Cross-browser",
                },
                {
                  logo: <CypressLogo />,
                  name: "Cypress",
                  sub: "Integration testing · Fast feedback loop",
                },
                {
                  logo: <JiraLogo />,
                  name: "Jira / Trello",
                  sub: "Agile workflows · Task management",
                },
                {
                  logo: <GitHubLogo />,
                  name: "GitHub / GitLab / Notion",
                  sub: "Version control · Project management · Knowledge base",
                },
              ],
            },
          ].map((group, idx) => (
            <div
              key={idx}
              className={idx > 0 ? "mt-10" : "relative group/category"}
            >
              {group.label === "Development" && (
                <div className="absolute top-[-10px] left-0 w-[240px] h-[100px] pointer-events-none hidden md:block opacity-40">
                  ...
                  <svg
                    className="absolute top-[-20px] left-[-20px] w-full h-full opacity-10"
                    viewBox="0 0 240 100"
                  >
                    <path
                      d="M10 80 Q 60 0 120 80"
                      stroke="#88CE02"
                      strokeWidth="1"
                      fill="none"
                      strokeDasharray="4 4"
              ...
              <div className="font-mono text-[11px] tracking-[0.2em] uppercase text-muted mb-6 reveal">
                {group.label}
              </div>
