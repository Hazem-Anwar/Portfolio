export const cases = [
  ...
  },
  {
    ...
    description: "Places reimagines residential and hotel booking as a continuous journey — from discovery, to reservation, to physical access. Not a listing platform, but a decision ecosystem.",
    stats: [
    ...
    keyTakeaways: [
      ...
      },
      {
        ...
        content: "The unified Design System was a strategic business asset, not just a component library. Building it early gave the project the agility to expand from simple booking into full 'Smart Stay' services in weeks. I treated the design system as a technical engine that directly drove operational efficiency and ensured a consistent brand voice across every guest touchpoint."
      },
      {
        title: "Architecture Built for Seamless Growth",
        content: "Designing for the future of travel taught us that architecture must be frictionless to survive rapid expansion. We prioritized guest intuition and technical scalability, ensuring that as 'Places' grew from a single listing into a global ecosystem, the user journey remained stable. I focused on a flexible foundation that allowed the product to evolve without technical or visual debt."
      }
    ],
    problem: "Modern booking platforms create more confusion than clarity. Users are forced to scroll through endless options, jump between fragmented information, and make high-stress decisions with low trust. The result is not choice — it is overload.",
    approach: "Instead of increasing options, we reduce friction. Instead of pushing exploration, we guide decisions. We replaced traditional filters with a guided exploration layer: one intelligent search input and visual-first cards that speak faster than text.",
    architecture: "The product evolves from a booking tool into a stay companion system. We removed the gap between digital and physical entirely through structured digital access cards and instant actions for real-world execution.",
    designSystem: "Focuses on confidence through immersive visual storytelling and strong hierarchy. Each element is a compressed answer designed for fast scanning and instant understanding. The system emphasizes transactional clarity, using a split-view synchronized layout to reduce cognitive load during the checkout and stay management phases.",
    prototyping: "The most defining experience is the Smart Lock control. Users can lock/unlock in real time with instant status feedback and secure identity-based access flow, designed for one-tap interaction at arrival.",
    testing: "At checkout, the trust moment, every element is simplified with clear cost breakdown and human-readable policies to ensure reassurance rather than just persuasion.",
    outcome: "Places is a shift in how digital products influence real-world decisions. From fragmented choices to guided clarity. From browsing to deciding. From booking to control.",
    slug: "places",
    detailedSections: [
      {
        title: "Discovery — From Searching to Feeling",
        subTitle: "The first moment is not about search. It’s about direction.",
        content: "We replaced traditional filters with a guided exploration layer: one intelligent search input, visual-first cards that speak faster than text, and only meaningful signals like price, rating, and location. No noise. No distraction. Just clarity.",
      ...
      },
      {
        ...
        content: "Everything is simplified to ensure reassurance: clear, transparent cost breakdown, human-readable policies, and zero cognitive overload. At checkout, the goal is not persuasion — it is reassurance.",
        image: "/images/Projects/places/2.png"
      },
      {
        title: "In-Stay Services",
        subTitle: "Elevate your stay with ease.",
        content: "Request housekeeping, laundry, or maintenance directly from your room for a seamless experience. The product evolves from a booking tool into a stay companion system.",
        image: "/images/Projects/places/3.png"
      },
      {
        title: "THE SYSTEM THINKING",
        subTitle: "What makes Places different is not screens… it is the connection between them.",
        content: "Discovery → Decision → Booking → Access → Control. A single continuous loop. Places is not a booking redesign. It is a shift in how digital products influence real-world decisions. From fragmented choices to guided clarity. From browsing to deciding. From booking to control.",
        image: "/images/Projects/places/4.png"
      },
      {
        title: "Smart Stay: Redefining the Guest Journey",
        subTitle: "Simplifying arrival and stay.",
        content: "I designed this ecosystem to transform the traditional stay into a frictionless digital experience. By replacing physical keys with Smart Access and integrating an In-App Concierge, I eliminated common traveler 'pain points.'\n\nOur 'outside-the-box' approach ensures that every guest has total control—from unlocking their door to requesting services—with a single tap. It’s not just a booking app; it’s a seamless, tech-forward lifestyle designed for maximum comfort and efficiency.",
        image: "/images/Projects/places/5.png"
      },
      {
        title: "Listings — Decision at a Glance",
        subTitle: "Listings are no longer a catalog. They are a decision surface.",
        content: "Each card is designed as a compressed answer: what it looks like, what it costs, how good it is, and where it is. Everything else is intentionally hidden until needed. The result: fast scanning, instant understanding, and quicker decisions.",
      ...
      },
      {
        ...
        content: "The design focuses on confidence: immersive visual storytelling through imagery, a strong hierarchy that leads the eye naturally, and a persistent booking element that stays present without being intrusive.",
